...
{
    string dotPath = outputPath + "/network_ids.dot";
    string pngPath = outputPath + "/network_ids.png";
    ...
    dot << "digraph SocialNetworkIDs {\n";
    dot << "    rankdir=LR;\n";
    dot << "    node [shape=ellipse, style=filled, fillcolor=lightblue, fontname=\"Arial\"];\n";
    dot << "    edge [fontname=\"Arial\"];\n\n";
